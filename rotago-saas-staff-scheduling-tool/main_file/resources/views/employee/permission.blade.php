    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('acount_type', ['3' => 'Employee', '2' => 'Manager', '1' => 'Admin'], (!empty($userr->acount_type)) ? $userr->acount_type : null , ['data-placeholder'=> 'Select Account Type' ,'class'=> 'form-control js-single-select manager_manag_emp']) !!}
                @elseif(Auth::user()->acount_type == 2)
                {!! Form::select('acount_type', ['3' => 'Employee', '2' => 'Manager'], (!empty($userr->acount_type)) ? $userr->acount_type : null, ['data-placeholder'=> 'Select Account Type' ,'class'=> 'form-control js-single-select manager_manag_emp']) !!}
                @endif
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 manager_permission_data" style="display: none">
            ...
            @if(!empty($location_option1))            
                ...
                @endforeach
            @else
                <label class="mx-2"> <small> {{ __('No loaction found...!') }} </small> </label>
            @endif
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 manager_permission_data" style="display: none">
