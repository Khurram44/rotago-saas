                ...
                <div class="container-fluid">
                            ...
                            <li class="nav-item dropdown dropdown-animate">
                                <a class="nav-link pr-lg-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="User Image"  src="{{ asset(Storage::url(Auth::user()->getUserInfo->DefaultProfilePic())) }}" class="avatar rounded-circle">>
                                    </span>
                                </a>
                    ...
                    <div class="collapse navbar-collapse navbar-collapse-fade" id="navbar-main-collapse">
                        <ul class="navbar-nav align-items-lg-center">
                            ...
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="{{ url('user') }}"> {{ __('User') }} </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="{{ url('plan') }}"> {{ __('Plan') }} </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="{{ url('coupon') }}"> {{ __('Coupon') }} </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="{{ url('order') }}"> {{ __('Order') }} </a> </li>                            
                            <li class="nav-item">  <a class="nav-link pl-lg-0" href="{{ url('manage-language',Auth::user()->lang) }}"> {{ __('Language') }} </a> </li>
