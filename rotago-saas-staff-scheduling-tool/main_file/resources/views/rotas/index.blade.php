                    ...
                    <div class="rotas_filter_main_div">                        
                        ...
                        <div class="d-inline-block">
                            <a href="#" data-url2="{{route('rotas.share_popup')}}"
                                class="btn btn-sm btn-md btn-white btn-icon-only rounded-circle ml-1 share_rotas_cls"  title="{{ __('Print rotas') }}" data-size="lg" data-ajax-popup="false" data-title="{{__('Share rotas')}}">
