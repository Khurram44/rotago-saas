...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        $members = User::where('created_by', '=', $objUser->get_created_by())->where('type', '=', 'employee')->get();        
        // if($objUser->type == 'Owner')
        // {
        //     $members = User::where('created_by', '=', $objUser->get_created_by())->where('type', '!=', 'Client')->get();
        // }
        // else
        // {
        //     $members = User::where('created_by', '=', $objUser->get_created_by())->where('id', '!=', $objUser->id)->where('type', '!=', 'Client')->orWhere('id', '=', $objUser->get_created_by())->get();
        // }
    ...
    public function search(Request $request)
    {
        ...
        $objUser = Auth::user();
        $records = User::where('created_by', $objUser->get_created_by())->where('type', 'employee')->where('first_name', 'LIKE', "%{$input}%");

        // dd($records->toSql(), "%{$input}%");
        // if($objUser->type == 'Owner')
        // {
        //     $records = User::where('created_by', '=', $objUser->get_created_by())->where('type', '!=', 'Client')->where('first_name', 'LIKE', "%{$input}%");
        // }
        // else
        // {
        //     $records = User::where('created_by', '=', $objUser->get_created_by())->where('id', '!=', $objUser->id)->where('type', '!=', 'Client')->orWhere('id', '=', $objUser->get_created_by())->where('name', 'LIKE', "%{$input}%");
        // }
